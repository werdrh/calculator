(() => {
    ...
    (() => {
        ...
        function rangeInit() {
            const priceSliderOne = document.querySelector(".range1");
            const bigValueSpan = document.getElementById("range-value1");
            if (priceSliderOne) {
                priceSliderOne.getAttribute("data-from");
                priceSliderOne.getAttribute("data-to");
                ...
                priceSliderOne.noUiSlider.on("update", (function(values, handle) {
                    bigValueSpan.innerHTML = Math.round(values[handle]);
                }));
            }
            const priceSliderTwo = document.querySelector(".range2");
            const bigValueSpanTwo = document.getElementById("range-value2");
            if (priceSliderTwo) {
                priceSliderOne.getAttribute("data-from");
                priceSliderOne.getAttribute("data-to");
                ...
                priceSliderTwo.noUiSlider.on("update", (function(values, handle) {
                    bigValueSpanTwo.innerHTML = Math.round(values[handle]);
                }));
            }
            const priceSliderThree = document.querySelector(".range3");
            const bigValueSpanThree = document.getElementById("range-value3");
            if (priceSliderThree) {
                priceSliderOne.getAttribute("data-from");
                priceSliderOne.getAttribute("data-to");
                ...
                priceSliderThree.noUiSlider.on("update", (function(values, handle) {
                    bigValueSpanThree.innerHTML = Math.round(values[handle]);
                }));
            }
            const priceSliderFor = document.querySelector(".range4");
            const bigValueSpanFor = document.getElementById("range-value4");
            if (priceSliderFor) {
                priceSliderFor.getAttribute("data-from");
                priceSliderFor.getAttribute("data-to");
                nouislider.create(priceSliderFor, {
                    start: 30,
                    connect: [ true, false ],
                    range: {
                        min: [ 22 ],
                ...
                priceSliderFor.noUiSlider.on("update", (function(values, handle) {
                    bigValueSpanFor.innerHTML = Math.round(values[handle]);
                }));
            }
            const priceSliderFive = document.querySelector(".range5");
            const bigValueSpanFive = document.getElementById("range-value5");
            if (priceSliderFive) {
                nouislider.create(priceSliderFive, {
                    start: 12,
                    connect: [ true, false ],
                    range: {
                        min: [ 1 ],
                ...
                priceSliderFive.noUiSlider.on("update", (function(values, handle) {
                    bigValueSpanFive.innerHTML = Math.round(values[handle]);
                }));
            }
        }
        rangeInit();
        setInterval((function() {
            const Prs = document.getElementById("form-calculator__price1");
            const RangeValue1 = parseInt(document.getElementById("range-value1").innerHTML);
            const y = parseInt(document.getElementById("range-value2").innerHTML);
            const a = parseInt(document.getElementById("range-value3").innerHTML);
            let x = 0;
            let Prise = 0;
            let b = 0;
            let z = 0;
            ...
            x = b * RangeValue1;
            Prise = (x + (100 - y) / 10 * z - (x + (100 - y) / 10 * z) * (y / 100)) / a;
            Prs.innerHTML = Math.trunc(Prise);
        }));
        setInterval((function() {
            const Prst = document.getElementById("form-calculator__price2");
            const RangeValue4 = parseInt(document.getElementById("range-value4").innerHTML);
            const d = parseInt(document.getElementById("range-value5").innerHTML);
            let Prises = 0;
            let b = 0;
            let z = 0;
            let v = 167;
            ...
            Prises = (b + v * d) * RangeValue4 / d;
            Prst.innerHTML = Math.trunc(Prises);
        }));
